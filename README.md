...
- **Import / export** — create projects from exported JSON files, export full projects (ideas, groups, and connections), and export an AI-ready JSON blueprint with sample data and field guidance
...
| Export blueprint | Click **New project** → **Export Blueprint** (includes examples + field guide for AI) |
